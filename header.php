			...
			<?php if ( false !== et_get_option( 'show_search_icon', true ) || is_customize_preview() ) : ?>
				...
				<?php
					...
					if ( function_exists( 'woocommerce_product_search' ) ) :
						echo woocommerce_product_search( array(
							'dynamic_focus' => 'no',
							'floating' => 'no',
							'placeholder' => __( 'Product search &hellip;', 'Divi' )
					) );
					else :
				?>
	...
	<?php endif; // true ==== $et_slide_header ?>
		...
		<header id="main-header" data-height-onload="<?php echo esc_attr( et_get_option( 'menu_height', '66' ) ); ?>">
			...
			<div class="et_search_outer">
				<div class="container divi_child_wps_search_form_container et_pb_search_form_hidden" style="display:none">
					<?php
						// WooCommerce Product Search by @itthinx
						if ( function_exists( 'woocommerce_product_search' ) ) :
							echo woocommerce_product_search( array(
